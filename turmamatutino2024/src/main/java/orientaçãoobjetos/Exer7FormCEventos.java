 ...
 * @author Senac
 */
public class Exer7FormCEventos extends javax.swing.JFrame {

    /**
     * Creates new form Exer7FormCEventos
     */
    public Exer7FormCEventos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Exer7FormCEventos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Exer7FormCEventos().setVisible(true);
            }
        });
    }
